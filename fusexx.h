...
namespace fusexx
{
    ...
    class fuse
    {
        ...
        public:
            ...
            static int f_mknod (const char *, mode_t, dev_t) {
                FUSE_RET
            }
            ...
            static int f_chmod (const char *, mode_t) {
                FUSE_RET
            }
            ...
            static int f_release (const char *, struct fuse_file_info *) {
                FUSE_RET
            }
            static int f_fsync (const char *, int, struct fuse_file_info *) {
                FUSE_RET
            }
#ifndef __APPLE__
            ...
            static int f_listxattr (const char *, char *, size_t) {
                FUSE_RET
            }
            static int f_removexattr (const char *, const char *) {
                FUSE_RET
            }
#endif
            ...
            static int f_releasedir (const char *, struct fuse_file_info *) {
                FUSE_RET
            }
